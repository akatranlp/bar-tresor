...
void loop()
{
  ...
  case State::WAIT_FOR_RFID:
  {
    ...
    if (cardId != -1)
    {
      ...
      else
      {
        if (cardId == 1)
        {
          game = new Game1(&soundPlayer, &distancePlayer, &displayPlayer, &touchPlayer, &rotatePlayer, &keyPlayer);
        }
        else if (cardId == 2)
        {
          game = new Game2(&soundPlayer, &distancePlayer, &displayPlayer, &touchPlayer, &rotatePlayer, &keyPlayer);
        }
        else if (cardId == 3)
        {
          game = new Game3(&soundPlayer, &distancePlayer, &displayPlayer, &touchPlayer, &rotatePlayer, &keyPlayer);
        }
  ...
  Serial.println(analogRead(ROTATE_PIN_LEFT));
  Serial.println(analogRead(ROTATE_PIN_RIGHT));
  ...
  if (digitalRead(TOUCH_PIN_RIGHT))
  {
    Serial.println("TOUCHED RIGHT");
  }
  if (digitalRead(TOUCH_PIN_LEFT))
  {
    Serial.println("TOUCHED LEFT");
  }
  if (digitalRead(TOUCH_PIN_TOP))
  {
    Serial.println("TOUCHED TOP");
  }
  if (digitalRead(TOUCH_PIN_BACK))
  {
    Serial.println("TOUCHED BACK");
  }
  ...
  else if (digitalRead(TOUCH_PIN_TOP))
  {
    Serial.println("TOUCHED TOP");
  }
  else if (digitalRead(TOUCH_PIN_LEFT))
  {
    Serial.println("TOUCHED LEFT");
  }
  else if (digitalRead(TOUCH_PIN_RIGHT))
  {
    Serial.println("TOUCHED RIGHT");
  }
