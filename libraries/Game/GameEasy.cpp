...
static TouchPlayer::Touch rightTouches[4] = {};
static const TiltPlayer::Tilt tiltSequence[4] = {TiltPlayer::Tilt::Backward, TiltPlayer::Tilt::Right, TiltPlayer::Tilt::Forward, TiltPlayer::Tilt::Left};
...
bool GameEasy::update(unsigned long delta, int distance)
{
    switch (m_state)
    {
    case State::CLOCK:
